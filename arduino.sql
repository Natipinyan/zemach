...
CREATE TABLE `environmental_data_avg` (
                                          ...
                                          `device_id` int(11) DEFAULT NULL,
                                          `UV_radiation` int(11) DEFAULT NULL,
                                          `lightIntensity` int(11) DEFAULT NULL,
                                          ...
                                          `UV_radiation_max` int(11) DEFAULT NULL,
                                          `UV_radiation_min` int(11) DEFAULT NULL,
                                          `lightIntensity_max` int(11) DEFAULT NULL,
                                          `lightIntensity_min` int(11) DEFAULT NULL,
                                          ...
                                          `soilMoisture_max` int(11) DEFAULT NULL,
                                          `soilMoisture_min` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `environmental_data_avg` (`id`, `device_id`, `UV_radiation`, `lightIntensity`, `temperature`, `humidity`, `soilMoisture`, `measurement_date`, `plant_ID`, `UV_radiation_max`, `UV_radiation_min`, `lightIntensity_max`, `lightIntensity_min`, `temperature_max`, `temperature_min`, `humidity_max`, `humidity_min`, `soilMoisture_max`, `soilMoisture_min`) VALUES
